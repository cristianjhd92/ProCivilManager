        ...
        <div className="flex items-center gap-4 relative">
          {!isLoggedIn ? (
            ...
            <>
              ...
              {isMenuOpen && (
                <div
                  className="absolute right-0 mt-2 w-56 rounded-lg shadow-lg border border-white/20 z-50 top-full"
                  style={{
                ...
                >
                  ...
                  <div className="px-4 py-3 border-b border-white/10 text-white">
                    ...
                    <div className="text-sm text-gray-400 italic">Rol: {userRole}</div>
                  </div>
